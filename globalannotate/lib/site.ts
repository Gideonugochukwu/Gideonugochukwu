...
// Header navigation — trimmed to the essentials for a calmer, minimalist
// bar. Reviews and Join Our Network remain linked from the footer, and every
// route stays live and in the sitemap.
export const nav = [
  { href: "/", label: "Home" },
